                    ...
                    <div id="collapse${index}" class="accordion-collapse collapse" aria-labelledby="heading${index}" data-bs-parent="#accordionServicos">
                        <div class="accordion-body bg-light">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <a class="btn btn-outline-primary btn-sm mx-1" onclick="window.location.href = '/visualizar_servico?id=${servico.id}'; return false;">
                                    <i class="fa-solid fa-eye"></i> Visualizar
                                </a>
                                <a class="btn btn-outline-warning btn-sm mx-1" onclick="if (confirm('Deseja realmente mover o serviço para em andamento?')) { atualizarStatusServico(${servico.id}, 'EM_ANDAMENTO'); } return false;">
